 ...
 return (
  ...
  <div className="testimonials">
    ...
    <blockquote className="testimonial-text">
      ...
      Inexpensive, healthy and great-tasting Ice-Cream. It tastes truly magical!
    </blockquote>
...
<figure className="testimonial">
  ...
  <figure className="testimonial">
    ...
    <blockquote className="testimonial-text">
      ...
      Divine Ice-cream is a life saver! I couldn't live without this Ice-cream.
    </blockquote>
